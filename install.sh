...
echo -e "    ${GREEN}/st-contract${NC}   Define API contract → mocks + ports + client"
echo -e "    ${GREEN}/st-agent${NC}      Launch autonomous backend implementation"
echo -e "    ${GREEN}/st-ui${NC}         Generate component from UI spec"
echo -e "    ${GREEN}/st-board${NC}      GitHub Issues/PRs status board"
echo -e "    ${GREEN}/st-integrate${NC}  Replace mocks with real backend"
echo ""
echo -e "  ${BOLD}Engineering pipeline:${NC}"
echo -e "    ${BLUE}/st-quick${NC}      Fast path (validate + commit)"
echo -e "    ${BLUE}/st-spec${NC}       Formal spec"
echo -e "    ${BLUE}/st-build${NC}      Layer-by-layer generation"
echo -e "    ${BLUE}/st-check${NC}      Validation pipeline"
echo -e "    ${BLUE}/st-ship${NC}       Pre-deploy audit + PR"
echo -e "    ${BLUE}/st-retro${NC}      Session close"
echo ""
echo -e "  ${BOLD}Utilities:${NC}"
echo -e "    ${DIM}/st-model${NC}       DDD domain model"
echo -e "    ${DIM}/st-mutate${NC}      Mutation testing"
echo -e "    ${DIM}/st-status${NC}      Progress report"
echo ""
